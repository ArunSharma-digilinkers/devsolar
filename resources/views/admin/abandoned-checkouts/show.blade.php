...
<div class="main-wrapper py-4">
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('abandoned-checkouts.index') }}" class="btn btn-outline-secondary" style="border-radius: 50px;">
        ...
        <div class="row g-4">
            ...
            {{-- Actions --}}
            <div class="col-12">
                <form action="{{ route('abandoned-checkouts.destroy', $checkout->id) }}" method="POST"
