...
<div class="main-wrapper section-entry">
    <div class="container py-5">
            ...
            <div class="col-lg-4">
                <div class="border rounded p-4">
                    ...
                    <p class="text-muted small mt-4">
                        ...
                        <a href="{{ route('login', ['redirect' => url('/cart')]) }}" class="fw-semibold">Login</a>
                        <br>
                        New here?
        ...
        <div class="text-center py-5">
            <i class="fas fa-shopping-cart fa-4x text-muted mb-3 d-block text-center"
                style="display: inline-block; width: auto;"></i>
